...
class User(db.Model, UserMixin):
    ...
    def to_dict(self):
        return {
            ...
            'followers': [{'id': follow.id, 'username': follow.username} for follow in self.following],
            'following': [{'id': follow.id, 'username': follow.username} for follow in self.followers]
